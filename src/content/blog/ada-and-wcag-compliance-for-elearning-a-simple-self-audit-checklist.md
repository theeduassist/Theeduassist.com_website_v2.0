...
aiSummary: This guide explains how to conduct a simple ADA and WCAG self-audit
  for eLearning courses in the USA. It covers essential accessibility checks
  including color contrast, keyboard navigation, alt text, captions, heading
  structure, forms, reading level, mobile accessibility, time limits, and LMS
  settings. The article also discusses common accessibility problems, typical
  costs for fixing small, medium, and large issues, ongoing accessibility
  audits, and how AI-powered tools can support accessibility checks. It
  emphasizes building accessibility into future courses rather than treating it
  as an afterthought.
...
You can also review common [e-learning design mistakes](https://www.theeduassist.com/blog/study-e-learning-design-mistakes-that-prevents-retention-rate-of-the-learner/) that can affect learner experience and course usability.
...
Free options include the WAVE accessibility checker, axe DevTools, and the Colour Contrast Analyser. These tools scan pages and highlight common problems. They will not catch everything, but they offer a strong starting point before deeper manual testing.

## References

World Wide Web Consortium. WCAG 2.2 Guidelines. [https://www.w3.org/WAI/standards-guidelines/wcag/](https://www.w3.org/WAI/standards-guidelines/wcag/)

[ADA.gov](http://ADA.gov). Americans with Disabilities Act Information. [https://www.ada.gov/](https://www.ada.gov/)

WebAIM. Introduction to Web Accessibility. [https://webaim.org/intro/](https://webaim.org/intro/)

[Section508.gov](http://Section508.gov). IT Accessibility Laws and Policies. [https://www.section508.gov/](https://www.section508.gov/)

W3C Web Accessibility Initiative. Easy Checks, A First Review of Web Accessibility. [https://www.w3.org/WAI/test-evaluate/preliminary/](https://www.w3.org/WAI/test-evaluate/preliminary/)
