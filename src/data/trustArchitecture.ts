...
export const trustPages: readonly TrustPage[] = [
  {
    ...
    primaryCta: { label: "Discuss Your Project Requirements", href: "/enterprise-solutions/project-brief/" },
  ...
  },
  {
    ...
    evidenceStatus: "verified",
    primaryCta: { label: "Discuss a Learning Engagement", href: "/contact/" }
  },
  {
    id: "responsible-ai",
    ...
    relatedServiceIds: [],
    evidenceStatus: "verified",
    primaryCta: { label: "Discuss AI Learning Requirements", href: "/enterprise-solutions/ai-workforce-readiness/" }
  },
  {
    id: "accessibility",
    ...
    evidenceStatus: "verified",
    primaryCta: { label: "Discuss Accessibility Requirements", href: "/enterprise-solutions/project-brief/" }
  },
  {
    id: "security-privacy",
    ...
    relatedServiceIds: [],
    evidenceStatus: "verified",
    primaryCta: { label: "Discuss Project-Specific Requirements", href: "/contact/" }
  },
  {
    id: "procurement",
    ...
    relatedServiceIds: [],
    evidenceStatus: "verified",
    primaryCta: { label: "Submit Initial Project Requirements", href: "/enterprise-solutions/project-brief/" }
  }
];
